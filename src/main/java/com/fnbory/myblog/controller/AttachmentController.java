...
//	@ResponseBody
//	public CommonResult upload(@RequestParam(value = "file") MultipartFile file, HttpServletRequest request) {
...
//	@ResponseBody
//	public CommonResult deleteAttachment(@RequestParam(value = "id") int id, HttpServletRequest request) {
...
//					return new CommonResult(MaydayEnums.OPERATION_ERROR.isFlag(),
//							MaydayEnums.OPERATION_ERROR.getMessage());
//				}
//			}
//		} catch (Exception e) {
//			log.error("删除文件" + attachment.getPictureName() + "失败");
//			return new CommonResult(MaydayEnums.ERROR.isFlag(), MaydayEnums.ERROR.getMessage());
//		}
//		return new CommonResult(MaydayEnums.OPERATION_SUCCESS.isFlag(), MaydayEnums.OPERATION_SUCCESS.getMessage());
//	}
//
//	/**
//	 * 上传功能
...
//	 * @return
//	 */
//	public CommonResult uploadAttachment(@RequestParam(value = "file") MultipartFile file, HttpServletRequest request) {
//		if (!file.isEmpty()) {
//			try {
//				// 获取用户目录
//				String userPath = System.getProperties().getProperty("user.home") + "/mayday/";
...
//				return new CommonResult(false, "系统未知错误");
//			}
//		} else {
//			return new CommonResult(false, "文件不能为空");
//		}
