...
import com.fnbory.myblog.dao.ArticleCategoryRelationMapper;
import com.fnbory.myblog.dao.ArticleMapper;
import com.fnbory.myblog.dao.ArticleTagMapper;
import com.fnbory.myblog.dao.customer.ArticleMapperCustom;
import com.fnbory.myblog.dao.customer.CategoryMapperCustom;
import com.fnbory.myblog.dao.customer.TagMapperCustom;
...
public class ArticleServiceImpl implements ArticleService {
	...
	@Autowired
	private ArticleCategoryRelationMapper articleCategoryMapper;
	@Autowired
	...
	public void save(Article article, Long[] tags, Long[] categorys) throws Exception {
		...
		if (categorys != null) {
			Arrays.asList(categorys).stream().forEach(cate -> {
				ArticleCategoryRelation articleCategory = new ArticleCategoryRelation();
	...
	public void remove(int id) throws Exception {
		...
		ArticleCategoryRelationExample articleCategoryExample = new ArticleCategoryRelationExample();
		ArticleCategoryRelationExample.Criteria categoryCriteria = articleCategoryExample.createCriteria();
