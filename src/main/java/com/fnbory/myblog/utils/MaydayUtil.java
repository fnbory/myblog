package com.fnbory.myblog.utils;
...
public class MaydayUtil {
	...
	public static String buildRss(List<ArticleCustom> articles)throws FeedException{
		 ...
		 if(BlogConst.OPTIONS.get("blog_name")==null) {
			 channel.setTitle("");
		 }else {
			 channel.setTitle(BlogConst.OPTIONS.get("blog_name"));
		 }
		 if(BlogConst.OPTIONS.get("blog_url")==null) {
			 channel.setLink("");
		 }else {
			 channel.setLink(BlogConst.OPTIONS.get("blog_url"));
		 }
		 if(BlogConst.OPTIONS.get("blog_url")==null) {
			 channel.setUri("");
		 }else {
			 channel.setUri(BlogConst.OPTIONS.get("blog_url"));
		 }
		 if(BlogConst.OPTIONS.get("seo_describe")==null) {
			 channel.setDescription("");
		 }else {
			 channel.setDescription(BlogConst.OPTIONS.get("seo_describe"));
		 }
		...
		for (int i = 0; i < articles.size(); i++) {
			...
			item.setLink(BlogConst.OPTIONS.get("blog_url")+"/post/"+articles.get(i).getArticleUrl());
